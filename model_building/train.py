...
Xtrain_path = "hf://datasets/Abhinavbhatnagar/mlops-tourism-project/Xtrain.csv"
Xtest_path = "hf://datasets/Abhinavbhatnagar/mlops-tourism-project/Xtest.csv"
ytrain_path = "hf://datasets/Abhinavbhatnagar/mlops-tourism-project/ytrain.csv"
ytest_path = "hf://datasets/Abhinavbhatnagar/mlops-tourism-project/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_travel_model_v1.joblib"
    ...
    api.upload_file(
        path_or_fileobj="best_travel_model_v1.joblib",
        path_in_repo="best_travel_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
